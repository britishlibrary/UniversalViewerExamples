...
$(function(){
    ...
    if (testBuild){
        $("body").append('<script type="text/javascript" id="embedUV" src="/build/uv-1.0.26/js/embed.js"><\/script>');
    } else {
        if (isLocalhost){
    ...
    $('#editBtn').on('click', function(e) {
        ...
        if ($('#editPnl').hasClass('show')){
            ...
            $.getJSON('/build/uv-1.0.26/js/uv-seadragon-extension-config.js', function(baseConfig){
